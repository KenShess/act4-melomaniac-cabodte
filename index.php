    ...
    <body id="page-top">
        ...
        <header class="bg-dark bg-gradient text-white">
            <div class="container px-4 text-center">
                <h1 class="fw-bolder">Welcome to Lyre Bird</h1>
                <p class="lead">Singing was my catharsis. It cleaned out the old, allowed room for the new to grow. It got my emotions back into sinus rhythm.</p>
